...
ALTER TABLE public.news_articles ADD COLUMN IF NOT EXISTS source TEXT;
...
Now you can use classes like `bg-brand-cyan` or `font-display` directly. This change makes development faster and more organized.',
